...
installed on most platforms using [[https://github.com/The404Hacking/distro][distro]]. You will also require
...
Bulat's [[https://github.com/The404Hacking/2D-and-3D-face-alignment/][face alignment]] code is included as a submodule. Please check
